        ...
        <section className="p-8">
          <div className="flex flex-col gap-6 justify-center items-center">
            ...
            <form
              ...
              className=" border-[#292b2e] border-2 border-solid py-3 px-4 rounded-full flex items-center gap-4 hover:bg-[#292b2e] hover:drop-shadow-m max-w-[500px] w-full justify-between"
            >
              <BiSearch />
              <input
                ...
                value={search}
                type="text"
                className="bg-transparent max-w-[500px] w-[100%]   outline-none"
              />
              <BiSolidMicrophone />
              <BiSolidCamera />
            </form>
            <div className="flex gap-3">
              <button
                className="bg-[#292b2e] px-5 py-2 rounded-lg hover:border-[#363a3d] hover:border-2 hover:border-solid border-2 border-transparent"
